...
namespace Vault {
    internal sealed class Interop {
        ...
        [DllImport("Vault")] internal static extern void vault_array_swap(IntPtr vault, int index1, int index2);
#else
        ...
        [DllImport("__Internal")] internal static extern void vault_array_swap(IntPtr vault, int index1, int index2);
#endif
